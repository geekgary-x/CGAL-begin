...
对于n维空间单纯形定义为：
$$
E = \{ p = s_{0}a_{0}+s_{1}a_{1}+...s_{n}a_{n}|s_{0}+s_{1}+...s_{n} = 1,s_{i}\ge 0 \}，
\{ a_{1}-a_{0}, a_{2}-a_{0}, ... , a_{n-1}-a_{0}, a_{n}-a_{0} \} 线性无关 
a_{i}\in \Re ^{n} ,s_{i}\in \Re
$$

如取二维空间三个向量 $ a_{0},a_{1},a_{2} $，和常数$ s_{0}, s_{1}, s_{2} $，则单纯形$ E=\{ p = s_{0}a_{0}+s_{1}a_{1}+s_{2}a_{2}|s_{0}+s_{1}+s_{2} = 1,s_{i}\ge 0\}  $。
